...
namespace LW_AskOnline.BLL
{
	...
	{
		private readonly Iask_test_bill dal=DataAccess.Createask_test_bill();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LW_AskOnline.Model.ask_test_bill GetModelByCache(int tid)
		{
			
			string CacheKey = "ask_test_billModel-" + tid;
			...
			return (LW_AskOnline.Model.ask_test_bill)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_test_bill> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_test_bill> DataTableToList(DataTable dt)
		{
			List<LW_AskOnline.Model.ask_test_bill> modelList = new List<LW_AskOnline.Model.ask_test_bill>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LW_AskOnline.Model.ask_test_bill model;
