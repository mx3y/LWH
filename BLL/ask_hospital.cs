...
namespace LW_AskOnline.BLL
{
	...
	{
		private readonly Iask_hospital dal=DataAccess.Createask_hospital();
		public ask_hospital()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LW_AskOnline.Model.ask_hospital GetModelByCache(int hid)
		{
			
			string CacheKey = "ask_hospitalModel-" + hid;
			...
			return (LW_AskOnline.Model.ask_hospital)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_hospital> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_hospital> DataTableToList(DataTable dt)
		{
			List<LW_AskOnline.Model.ask_hospital> modelList = new List<LW_AskOnline.Model.ask_hospital>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LW_AskOnline.Model.ask_hospital model;
