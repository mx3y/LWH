...
namespace LW_AskOnline.BLL
{
	...
	{
		private readonly Iask_order dal=DataAccess.Createask_order();
		public ask_order()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LW_AskOnline.Model.ask_order GetModelByCache(int oid)
		{
			
			string CacheKey = "ask_orderModel-" + oid;
			...
			return (LW_AskOnline.Model.ask_order)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_order> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_order> DataTableToList(DataTable dt)
		{
			List<LW_AskOnline.Model.ask_order> modelList = new List<LW_AskOnline.Model.ask_order>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LW_AskOnline.Model.ask_order model;
