...
namespace LW_AskOnline.BLL
{
	...
	{
		private readonly Iask_illpersion dal=DataAccess.Createask_illpersion();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public LW_AskOnline.Model.ask_illpersion GetModelByCache(int iid)
		{
			
			string CacheKey = "ask_illpersionModel-" + iid;
			...
			return (LW_AskOnline.Model.ask_illpersion)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_illpersion> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<LW_AskOnline.Model.ask_illpersion> DataTableToList(DataTable dt)
		{
			List<LW_AskOnline.Model.ask_illpersion> modelList = new List<LW_AskOnline.Model.ask_illpersion>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				LW_AskOnline.Model.ask_illpersion model;
