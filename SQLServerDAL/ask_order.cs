...
namespace LW_AskOnline.SQLServerDAL
{
    ...
    /// 数据访问类:ask_order
    /// </summary>
    public partial class ask_order : Iask_order
    {
        public ask_order()
        { }
        #region  BasicMethod
        ...
        public int Add(LW_AskOnline.Model.ask_order model)
        {
            ...
            strSql.Append("ouid,odid,otype,oresult,ostate,ocreatetime,ocommittime,opublicmonery,oprivatemonery,ototalmonery,otransid,ocallresult,ocallid,ocalldate,oillid,oillimg,oillcontent)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@oillid", SqlDbType.Int,4),
					new SqlParameter("@oillimg", SqlDbType.NVarChar,500),
					new SqlParameter("@oillcontent", SqlDbType.NVarChar,500)};
            ...
            parameters[14].Value = model.oillid;
            parameters[15].Value = model.oillimg;
            parameters[16].Value = model.oillcontent;
        ...
        public bool Update(LW_AskOnline.Model.ask_order model)
        {
            ...
            strSql.Append("oillid=@oillid,");
            strSql.Append("oillimg=@oillimg,");
            strSql.Append("oillcontent=@oillcontent");
            strSql.Append(" where oid=@oid");
            SqlParameter[] parameters = {
					new SqlParameter("@ouid", SqlDbType.Int,4),
					new SqlParameter("@odid", SqlDbType.Int,4),
        ...
        public LW_AskOnline.Model.ask_order GetModel(int oid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 oid,ouid,odid,otype,oresult,ostate,ocreatetime,ocommittime,opublicmonery,oprivatemonery,ototalmonery,otransid,ocallresult,ocallid,ocalldate,oillid,oillimg,oillcontent from ask_order ");
            strSql.Append(" where oid=@oid");
            SqlParameter[] parameters = {
					new SqlParameter("@oid", SqlDbType.Int,4)
			};
        ...
        public LW_AskOnline.Model.ask_order DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["oillid"] != null && row["oillid"].ToString() != "")
                {
                    model.oillid = int.Parse(row["oillid"].ToString());
                }
                if (row["oillimg"] != null)
                {
                    model.oillimg = row["oillimg"].ToString();
                }
                if (row["oillcontent"] != null)
                {
                    model.oillcontent = row["oillcontent"].ToString();
                }
            }
            return model;
        }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select oid,ouid,odid,otype,oresult,ostate,ocreatetime,ocommittime,opublicmonery,oprivatemonery,ototalmonery,otransid,ocallresult,ocallid,ocalldate,oillid,oillimg,oillcontent ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" oid,ouid,odid,otype,oresult,ostate,ocreatetime,ocommittime,opublicmonery,oprivatemonery,ototalmonery,otransid,ocallresult,ocallid,ocalldate,oillid,oillimg,oillcontent ");
            strSql.Append(" FROM ask_order ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
