...
namespace LW_AskOnline.SQLServerDAL
{
    ...
    public partial class ask_doctor_list : Iask_doctor_list
    {
        ...
        public int Add(LW_AskOnline.Model.ask_doctor_list model)
        {
            ...
            strSql.Append("dname,dimage,ddept,ddeptid,dtype,dhospital,dcityid,dcity,dhospitalid,dprofessor,dcontent,dmonery,dtell,ddiscount,dshowregister,dsrealregister,dshowtell,dsrealtell,dshowvideo,dsrealvideo,dbankaccount,dbankaname,dbanktype,dqq,daccount,dpassword,dcreadate,dlastlogin,dsort,dishot,dstate,d_onlinedate,d_message,d_count,d_score,d_professionscore,d_professioncount,d_servicesscore,d_servicescount,d_replyscore,d_replycount)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@d_onlinedate", SqlDbType.NVarChar,50),
					new SqlParameter("@d_message", SqlDbType.NVarChar,500),
					new SqlParameter("@d_count", SqlDbType.Int,4),
					new SqlParameter("@d_score", SqlDbType.NVarChar,50),
					new SqlParameter("@d_professionscore", SqlDbType.NVarChar,50),
					new SqlParameter("@d_professioncount", SqlDbType.NVarChar,50),
					new SqlParameter("@d_servicesscore", SqlDbType.NVarChar,50),
					new SqlParameter("@d_servicescount", SqlDbType.NVarChar,50),
					new SqlParameter("@d_replyscore", SqlDbType.NVarChar,50),
					new SqlParameter("@d_replycount", SqlDbType.NVarChar,50)};
            ...
            parameters[31].Value = model.d_onlinedate;
            parameters[32].Value = model.d_message;
            parameters[33].Value = model.d_count;
            parameters[34].Value = model.d_score;
            parameters[35].Value = model.d_professionscore;
            parameters[36].Value = model.d_professioncount;
            parameters[37].Value = model.d_servicesscore;
            parameters[38].Value = model.d_servicescount;
            parameters[39].Value = model.d_replyscore;
            parameters[40].Value = model.d_replycount;
        ...
        public bool Update(LW_AskOnline.Model.ask_doctor_list model)
        {
            ...
            strSql.Append("d_onlinedate=@d_onlinedate,");
            strSql.Append("d_message=@d_message,");
            strSql.Append("d_count=@d_count,");
            strSql.Append("d_score=@d_score,");
            strSql.Append("d_professionscore=@d_professionscore,");
            strSql.Append("d_professioncount=@d_professioncount,");
            strSql.Append("d_servicesscore=@d_servicesscore,");
            strSql.Append("d_servicescount=@d_servicescount,");
            strSql.Append("d_replyscore=@d_replyscore,");
            strSql.Append("d_replycount=@d_replycount");
            strSql.Append(" where did=@did");
            SqlParameter[] parameters = {
					new SqlParameter("@dname", SqlDbType.NVarChar,50),
					new SqlParameter("@dimage", SqlDbType.NVarChar,200),
        ...
        public LW_AskOnline.Model.ask_doctor_list DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["d_onlinedate"] != null)
                {
                    model.d_onlinedate = row["d_onlinedate"].ToString();
                }
                if (row["d_message"] != null)
                {
                    model.d_message = row["d_message"].ToString();
                }
                ...
                if (row["d_score"] != null)
                {
                    model.d_score = row["d_score"].ToString();
                }
                if (row["d_professionscore"] != null)
                {
                    model.d_professionscore = row["d_professionscore"].ToString();
                }
                if (row["d_professioncount"] != null)
                {
                    model.d_professioncount = row["d_professioncount"].ToString();
                }
                if (row["d_servicesscore"] != null)
                {
                    model.d_servicesscore = row["d_servicesscore"].ToString();
                }
                if (row["d_servicescount"] != null)
                {
                    model.d_servicescount = row["d_servicescount"].ToString();
                }
                if (row["d_replyscore"] != null)
                {
                    model.d_replyscore = row["d_replyscore"].ToString();
                }
                if (row["d_replycount"] != null)
                {
                    model.d_replycount = row["d_replycount"].ToString();
                }
            }
            return model;
        }
