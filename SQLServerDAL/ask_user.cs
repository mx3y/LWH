...
namespace LW_AskOnline.SQLServerDAL
{
    ...
    /// 数据访问类:ask_user
    /// </summary>
    public partial class ask_user : Iask_user
    {
        public ask_user()
        { }
        #region  BasicMethod
        ...
        public int Add(LW_AskOnline.Model.ask_user model)
        {
            ...
            strSql.Append("utijtid,ucompanymonery,umonery,uaccount,upassword,ucardnumber,uopenid,umail,ubrithday,usex,ucompanyid,uregisterdatetime,uregisterip,ulastdatetime,ulastip,ustate,uname)");
        ...
        public bool Update(LW_AskOnline.Model.ask_user model)
        {
            ...
            parameters[15].Value = model.ustate;
            parameters[16].Value = model.uname;
            parameters[17].Value = model.uuid;
        ...
        public LW_AskOnline.Model.ask_user GetModel(int uuid)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 uuid,utijtid,ucompanymonery,umonery,uaccount,upassword,ucardnumber,uopenid,umail,ubrithday,usex,ucompanyid,uregisterdatetime,uregisterip,ulastdatetime,ulastip,ustate,uname from ask_user ");
            strSql.Append(" where uuid=@uuid");
            SqlParameter[] parameters = {
					new SqlParameter("@uuid", SqlDbType.Int,4)
			};
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select uuid,utijtid,ucompanymonery,umonery,uaccount,upassword,ucardnumber,uopenid,umail,ubrithday,usex,ucompanyid,uregisterdatetime,uregisterip,ulastdatetime,ulastip,ustate,uname ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" uuid,utijtid,ucompanymonery,umonery,uaccount,upassword,ucardnumber,uopenid,umail,ubrithday,usex,ucompanyid,uregisterdatetime,uregisterip,ulastdatetime,ulastip,ustate,uname ");
            strSql.Append(" FROM ask_user ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
