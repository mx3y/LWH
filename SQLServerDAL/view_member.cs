...
namespace LW_AskOnline.SQLServerDAL
{
	...
	/// 数据访问类:view_member
	/// </summary>
	public partial class view_member:Iview_member
	{
		public view_member()
		{}
		#region  BasicMethod
		...
		public bool Add(LW_AskOnline.Model.view_member model)
		{
			...
			strSql.Append("member_type,member_id,address,auth_flag,auth_remark,auth_time,card_image1,card_image2,cash_pwd,city,company,county,create_date,email,id_number,last_check_date,last_check_id,last_review_date,login_name,login_pwd,member_name,member_no,mobile,open_id,province,sex)");
			...
			parameters[0].Value = model.member_type;
			parameters[1].Value = model.member_id;
			parameters[2].Value = model.address;
			parameters[3].Value = model.auth_flag;
			parameters[4].Value = model.auth_remark;
			parameters[5].Value = model.auth_time;
			parameters[6].Value = model.card_image1;
			parameters[7].Value = model.card_image2;
			parameters[8].Value = model.cash_pwd;
			...
			parameters[14].Value = model.id_number;
			parameters[15].Value = model.last_check_date;
			parameters[16].Value = model.last_check_id;
			parameters[17].Value = model.last_review_date;
			parameters[18].Value = model.login_name;
			parameters[19].Value = model.login_pwd;
			parameters[20].Value = model.member_name;
			parameters[21].Value = model.member_no;
			parameters[22].Value = model.mobile;
			parameters[23].Value = model.open_id;
		...
		public bool Update(LW_AskOnline.Model.view_member model)
		{
			...
			parameters[21].Value = model.open_id;
			parameters[22].Value = model.province;
			parameters[23].Value = model.sex;
			parameters[24].Value = model.member_type;
		...
		public LW_AskOnline.Model.view_member GetModel(string member_type,decimal member_id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 member_type,member_id,address,auth_flag,auth_remark,auth_time,card_image1,card_image2,cash_pwd,city,company,county,create_date,email,id_number,last_check_date,last_check_id,last_review_date,login_name,login_pwd,member_name,member_no,mobile,open_id,province,sex from view_member ");
			strSql.Append(" where member_type=@member_type and member_id=@member_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@member_type", SqlDbType.VarChar,10),
					new SqlParameter("@member_id", SqlDbType.Decimal,9)			};
			...
			LW_AskOnline.Model.view_member model=new LW_AskOnline.Model.view_member();
		...
		/// 得到一个对象实体
		/// </summary>
		public LW_AskOnline.Model.view_member DataRowToModel(DataRow row)
		{
			LW_AskOnline.Model.view_member model=new LW_AskOnline.Model.view_member();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select member_type,member_id,address,auth_flag,auth_remark,auth_time,card_image1,card_image2,cash_pwd,city,company,county,create_date,email,id_number,last_check_date,last_check_id,last_review_date,login_name,login_pwd,member_name,member_no,mobile,open_id,province,sex ");
