...
namespace LW_AskOnline.SQLServerDAL
{
    ...
    public partial class ask_city : Iask_city
    {
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(LW_AskOnline.Model.ask_city model)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            SqlParameter[] parameters = {
					new SqlParameter("@cid", SqlDbType.NVarChar,50),
					new SqlParameter("@cparent_id", SqlDbType.NVarChar,50),
					new SqlParameter("@cregion_grade", SqlDbType.NVarChar,50),
            ...
            parameters[1].Value = model.cparent_id;
            parameters[2].Value = model.cregion_grade;
            parameters[3].Value = model.cregion_name;
            parameters[4].Value = model.cdistrict_code;
            parameters[5].Value = model.carea_code;
            parameters[6].Value = model.cstatus;
        ...
        /// 得到一个对象实体
        /// </summary>
        public LW_AskOnline.Model.ask_city GetModel(string cid)
        {
        ...
        public LW_AskOnline.Model.ask_city DataRowToModel(DataRow row)
        {
            ...
            if (row != null)
            {
                ...
                if (row["cparent_id"] != null)
                {
                    model.cparent_id = row["cparent_id"].ToString();
                }
                if (row["cregion_grade"] != null)
                {
                    model.cregion_grade = row["cregion_grade"].ToString();
                }
